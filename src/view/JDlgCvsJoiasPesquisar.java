...
public class JDlgCvsJoiasPesquisar extends javax.swing.JDialog {
     ...
     */
    public JDlgCvsJoiasPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgCvsJoiasPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgCvsJoiasPesquisar dialog = new JDlgCvsJoiasPesquisar(new javax.swing.JFrame(), true);
