 ...
 * @author u1845853
 */
public class JDlgCvsVendasJoias extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgCvsVendasJoias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgCvsVendasJoias dialog = new JDlgCvsVendasJoias(new javax.swing.JFrame(), true);
